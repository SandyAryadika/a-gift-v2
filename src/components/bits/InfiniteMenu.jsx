...
import flowerIcon from '../../assets/flowers-100.png';
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <>
          {/* --- TITLE --- 
              Mobile: Di Atas Tengah (top-[10%]) 
              Desktop: Di Kiri Tengah (left-[5%]) 
          */}
          <h2
            className={`
              absolute
              ...
              /* Posisi Desktop (md) */
              md:top-1/2 md:left-[5%] md:translate-x-0 md:-translate-y-1/2 md:text-left
              md:text-7xl
          ...
          {/* --- DESCRIPTION --- 
              Mobile: Di Bawah (bottom-[20%]) 
              Desktop: Di Kanan (right-[10%]) 
          */}
          <div
             className={`
              absolute
              ...
              /* Posisi Mobile */
              bottom-[20%] left-1/2 -translate-x-1/2 text-center w-[80%]

              /* Posisi Desktop (md) */
              md:bottom-auto md:top-1/2 md:right-[10%] md:left-auto md:translate-x-0 md:-translate-y-1/2 md:text-right md:w-auto
            ...
            `}
          >
             <p className="text-sm md:text-xl font-light text-neutral-300">
               {activeItem.description}
             </p>
          </div>

          {/* --- TOMBOL TENGAH (CENTER) --- */}
          <div
            ...
            className={`
              ...
              ${
                isMoving
                  ...
                  : 'bottom-[10%] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
              }
            `}
          >
            {/* Ukuran Icon Responsive */}
            <img 
              src={flowerIcon} 
              alt="Icon" 
              className="w-6 h-6 md:w-8 md:h-8 object-contain select-none pointer-events-none"
              // Jika icon Anda berwarna hitam dan ingin dipaksa jadi putih,
              // aktifkan filter di bawah ini (hapus tanda //):
